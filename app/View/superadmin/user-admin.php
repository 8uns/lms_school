                                        ...
                                        <tr class="h-15 border-b border-t border-gray-300">
                                            ...
                                            <td class="px-4 py-2 flex justify-center gap-2">
                                                <div class="w-auto relative">
                                                    ...
                                                    modaledit = !modaledit
                                                    "
                                                        type="button" class="cursor-pointer bg-gradient-to-r from-slate-500 to-slate-400 w-full rounded-2xl text-white py-3 px-5 hover:from-slate-600 hover:to-slate-500 transition-all duration-300 shadow-md hover:shadow-lg active:scale-[0.98]">
