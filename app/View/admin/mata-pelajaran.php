                    ...
                    <div class="font-bold py-8 px-10 border-b border-gray-200 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col">
                                ...
                                <h6 class="text-base font-bold text-gray-800">Data Mata Pelajaran</h6>
                            </div>
                        </div>
                            ...
                            <table class="w-full text-center border-collapse">
                                <thead>
                                    <tr class="h-16 bg-gray-50/50 border-b border-gray-200 text-xs font-bold text-gray-500 uppercase tracking-wider">
                                        ...
                                        <th class="px-6 text-left">Nama Mata Pelajaran</th>
                                    ...
                                    <?php if (!empty($data['subjects'])): ?>
                                        <?php foreach ($data['subjects'] as $subjects): ?>
                                            <tr 
                                                ...
                                                x-show="search === '' || 
                                                        '<?= strtolower(addslashes($subjects['subject_name'])) ?>'.includes(search.toLowerCase())"
                                            >
                                                ...
                                                <td class="px-4 py-2">
                                                    <div class="flex items-center justify-center gap-1">
                                                        ...
                                                        <button
                                                            @click="
                                                                subjects = {id: '<?= $subjects['id'] ?>', subject_name: '<?= addslashes($subjects['subject_name']) ?>'}; 
                                                                modaledit = true;
                                                            "
                                                            type="button" 
        ...
        <form action="<?= base_url('/admin/mata-pelajaran') ?>" method="post" class="w-full max-w-lg">
            <div class="bg-white rounded-2xl p-8 shadow-xl" @click.away="modaladd = false">
                <div class="flex justify-between items-center mb-6 pb-4 border-b border-gray-100">
                    <h6 class="font-bold text-lg text-gray-800">Tambah Mata Pelajaran</h6>
                ...
                <div class="space-y-5 mb-8">
                    <div>
                        <label class="text-gray-700 text-xs font-bold uppercase tracking-wider block mb-2">Nama Mata Pelajaran</label>
                        <input required name="subject_name" type="text" class="border text-gray-700 border-gray-300 bg-white w-full rounded-2xl py-3 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-normal" placeholder="Contoh: Matematika...">
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-xl" @click.away="modaledit = false">
                <div class="flex justify-between items-center mb-6 pb-4 border-b border-gray-100">
                    <div>
                        ...
                        <h6 class="font-bold text-lg text-gray-800" x-text="subjects.subject_name"></h6>
                    </div>
                ...
                <div class="space-y-5 mb-8">
                    <div>
                        <label class="text-gray-700 text-xs font-bold uppercase tracking-wider block mb-2">Nama Mata Pelajaran</label>
                        <input x-model="subjects.subject_name" required name="subject_name" type="text" class="border text-gray-700 border-gray-300 bg-white w-full rounded-2xl py-3 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-normal" placeholder="Masukkan nama mata pelajaran...">
                    </div>
                </div>
    ...
    <div 
        ...
        <div class="bg-white rounded-2xl p-8 max-w-md w-full shadow-xl" @click.away="modaldel = false">
            <div class="text-center mb-6">
                ...
                <h6 class="text-lg font-bold text-gray-800 mb-2">Hapus Mata Pelajaran?</h6>
                <p class="text-sm text-gray-500">
                    Apakah Anda yakin ingin menghapus <span x-text="subjects.subject_name" class="font-bold text-gray-800"></span>?
                </p>
            </div>

            <div class="flex items-center gap-3">
                <a :href="'<?= base_url('/admin/mata-pelajaran/del') ?>/' + subjects.id" class="flex-1 text-center font-bold cursor-pointer bg-gradient-to-r from-rose-600 to-red-500 rounded-2xl text-white py-3 px-5 hover:from-rose-700 hover:to-red-600 transition-all duration-300 shadow-md hover:shadow-lg active:scale-[0.98] text-sm">
                    Ya, Hapus
                </a>
