...
<div class="ml-0 md:ml-72 sm:ml-0 bg-gray-100 min-h-screen"
                    ...
                    <div class="font-bold py-8 px-10 border-b border-gray-200 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col">
                                ...
                                <h6 class="text-base font-bold text-gray-800">Data Akun Siswa</h6>
                            </div>
                        </div>

                        <!-- Action Controls: Input Search, Import & Tombol Tambah -->
                        <div class="flex flex-col sm:flex-row items-center gap-3 w-full lg:w-auto">
                            ...
                            <div class="flex items-center gap-2 w-full sm:w-auto">
                                <button @click="modalup = !modalup" type="button" class="cursor-pointer bg-emerald-50 text-emerald-600 hover:bg-emerald-100 border border-emerald-200/60 w-full sm:w-auto rounded-2xl py-2.5 px-5 transition-all duration-300 active:scale-[0.98] flex items-center justify-center gap-2 font-semibold text-sm shrink-0">
                            ...
                            <table class="w-full text-center border-collapse">
                                <thead>
                                    <tr class="h-16 bg-gray-50/50 border-b border-gray-200 text-xs font-bold text-gray-500 uppercase tracking-wider">
                                        ...
                                        <th class="px-6 text-left">Username / NISN</th>
    ...
    <div 
        ...
        <form action="<?= base_url('/admin/siswa/import') ?>" method="post" enctype="multipart/form-data" class="w-full max-w-lg">
            <div class="bg-white rounded-2xl p-8 shadow-xl" @click.away="modalup = false">
                <div class="flex justify-between items-center mb-6 pb-4 border-b border-gray-100">
                    <div class="flex items-center gap-2.5">
                        <div class="w-8 h-8 bg-emerald-50 text-emerald-600 rounded-xl flex items-center justify-center">
                            <i class="ri-file-excel-2-line text-base"></i>
                        </div>
                        <h6 class="font-bold text-lg text-gray-800">Import Data Siswa</h6>
                    </div>
                    <button @click="modalup = false" type="button" class="cursor-pointer text-gray-400 hover:text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-xl p-2 transition-all">
                ...
                <div class="space-y-4 mb-8">
                    <div>
                        <label class="text-gray-700 text-xs font-bold uppercase tracking-wider block mb-2">Pilih File Spreadsheet</label>
                        <input name="importfile" type="file" required class="border border-gray-300 text-gray-700 bg-gray-50 w-full rounded-2xl py-2.5 px-4 text-sm cursor-pointer file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-semibold file:bg-emerald-50 file:text-emerald-700 hover:file:bg-emerald-100 transition-all">
                    </div>

                    <div class="bg-gray-50 border border-gray-200 rounded-2xl p-4 text-xs text-gray-600 space-y-1.5">
                        ...
                        <p class="pl-5">• Format file yang didukung: <span class="font-semibold text-gray-800">.xls, .xlsx, .csv</span></p>
                        <p class="pl-5">• Format header kolom: <span class="font-semibold text-gray-800 font-mono">nama, nisn</span></p>
                    </div>
                </div>

                <div>
                    <button type="submit" class="cursor-pointer bg-gradient-to-r from-emerald-600 to-teal-500 w-full rounded-2xl text-white py-3.5 px-5 hover:from-emerald-700 hover:to-teal-600 transition-all shadow-md hover:shadow-lg font-bold text-sm active:scale-[0.98] flex items-center justify-center gap-2">
    ...
    <div 
        ...
        <form action="<?= base_url('/admin/siswa') ?>" method="post" class="w-full max-w-lg">
            <div class="bg-white rounded-2xl p-8 shadow-xl" @click.away="modaladd = false">
                <div class="flex justify-between items-center mb-6 pb-4 border-b border-gray-100">
                    <h6 class="font-bold text-lg text-gray-800">Tambah Akun Siswa</h6>
                ...
                <div class="space-y-5 mb-8">
                    ...
                    <div>
                        <label class="text-gray-700 text-xs font-bold uppercase tracking-wider block mb-2">Username / NISN</label>
                        <input required name="username" type="text" class="border text-gray-700 border-gray-300 bg-white w-full rounded-2xl py-3 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-normal" placeholder="Masukkan NISN atau username...">
                    </div>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-xl" @click.away="modaledit = false">
                <div class="flex justify-between items-center mb-6 pb-4 border-b border-gray-100">
                    <div>
                        ...
                        <h6 class="font-bold text-lg text-gray-800" x-text="data.full_name"></h6>
                    </div>
                ...
                <div class="space-y-5 mb-8">
                    <div>
                        <label class="text-gray-700 text-xs font-bold uppercase tracking-wider block mb-2">Nama Lengkap</label>
                        <input x-model="data.full_name" required name="full_name" type="text" class="border text-gray-700 border-gray-300 bg-white w-full rounded-2xl py-3 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-normal" placeholder="Masukkan nama lengkap...">
                    </div>

                    <div>
                        <label class="text-gray-700 text-xs font-bold uppercase tracking-wider block mb-2">Username / NISN</label>
                        <input x-model="data.username" required name="username" type="text" class="border text-gray-700 border-gray-300 bg-white w-full rounded-2xl py-3 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-normal" placeholder="Masukkan username...">
                    </div>
                </div>
    ...
    <div 
        ...
        <div class="bg-white rounded-2xl p-8 max-w-md w-full shadow-xl" @click.away="modaldel = false">
            <div class="text-center mb-6">
                ...
                <h6 class="text-lg font-bold text-gray-800 mb-2">Hapus Akun Siswa?</h6>
                <p class="text-sm text-gray-500">
                    Apakah Anda yakin ingin menghapus akun <span x-text="data.full_name" class="font-bold text-gray-800"></span>?
                </p>
            </div>

            <div class="flex items-center gap-3">
                <a :href="'<?= base_url('/admin/siswa/del') ?>/' + data.user_id" class="flex-1 text-center font-bold cursor-pointer bg-gradient-to-r from-rose-600 to-red-500 rounded-2xl text-white py-3 px-5 hover:from-rose-700 hover:to-red-600 transition-all duration-300 shadow-md hover:shadow-lg active:scale-[0.98] text-sm">
                    Ya, Hapus
                </a>
