                    ...
                    <div class="font-bold py-8 px-10 border-b border-gray-200 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col">
                                ...
                                <h6 class="text-base font-bold text-gray-800">Data Tahun Ajaran</h6>
                            </div>
                        </div>
                            ...
                            <table class="w-full text-center border-collapse">
                                <thead>
                                    <tr class="h-16 bg-gray-50/50 border-b border-gray-200 text-xs font-bold text-gray-500 uppercase tracking-wider">
                                        ...
                                        <th class="px-6 text-left">Tahun Ajaran</th>
                                        <th class="px-6 text-center">Semester</th>
                                    ...
                                    <?php if (!empty($data['academic_years'])): ?>
                                        <?php foreach ($data['academic_years'] as $tahunAjaran): ?>
                                            ...
                                            >
                                                ...
                                                <td class="px-6 py-2 text-center font-semibold text-gray-600">
                                                    <?= htmlspecialchars($tahunAjaran['semester']); ?>
                                                </td>
                                                <td class="px-6 py-2 text-center">
                                                    <?php if ($tahunAjaran['is_active']): ?>
                                                        <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-emerald-50 text-emerald-600 border border-emerald-200/60">
                                                    ...
                                                    <div class="flex items-center justify-center gap-1">
                                                        ...
                                                        <?php if ($tahunAjaran['is_active']): ?>
                                                            <button
                                                                ...
                                                                class="cursor-not-allowed opacity-40 px-2.5 py-1.5 rounded-xl text-gray-400 flex items-center gap-1 font-semibold text-xs border border-transparent">
        ...
        <form action="<?= base_url('/admin/tahun-ajaran') ?>" method="post" class="w-full max-w-lg">
            <div class="bg-white rounded-2xl p-8 shadow-xl" @click.away="modaladd = false">
                <div class="flex justify-between items-center mb-6 pb-4 border-b border-gray-100">
                    <h6 class="font-bold text-lg text-gray-800">Tambah Tahun Ajaran</h6>
                ...
                <div class="space-y-5 mb-8">
                    <div>
                        <label class="text-gray-700 text-xs font-bold uppercase tracking-wider block mb-2">Nama Tahun Ajaran</label>
                        <input required name="year_name" type="text" class="border text-gray-700 border-gray-300 bg-white w-full rounded-2xl py-3 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-normal" placeholder="Contoh: 2024 / 2025...">
                    </div>

                    <div>
                        <label class="text-gray-700 text-xs font-bold uppercase tracking-wider block mb-2">Semester</label>
                        <select required name="semester" class="border text-gray-700 border-gray-300 bg-white w-full rounded-2xl py-3 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-normal">
            ...
            <div class="bg-white rounded-2xl p-8 shadow-xl" @click.away="modaledit = false">
                <div class="flex justify-between items-center mb-6 pb-4 border-b border-gray-100">
                    <div>
                        ...
                        <h6 class="font-bold text-lg text-gray-800" x-text="tahunAjaran.year_name + ' (' + tahunAjaran.semester + ')'"></h6>
                    </div>
                ...
                <div class="space-y-5 mb-8">
                    <div>
                        <label class="text-gray-700 text-xs font-bold uppercase tracking-wider block mb-2">Nama Tahun Ajaran</label>
                        <input x-model="tahunAjaran.year_name" required name="year_name" type="text" class="border text-gray-700 border-gray-300 bg-white w-full rounded-2xl py-3 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-normal" placeholder="Contoh: 2024/2025...">
                    </div>

                    <div>
                        <label class="text-gray-700 text-xs font-bold uppercase tracking-wider block mb-2">Semester</label>
                        <select x-model="tahunAjaran.semester" required name="semester" class="border text-gray-700 border-gray-300 bg-white w-full rounded-2xl py-3 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-normal">
                            <option value="">Pilih Semester</option>
                            <option value="Ganjil">Ganjil</option>
                            <option value="Genap">Genap</option>
                        </select>
    ...
    <div 
        ...
        <div class="bg-white rounded-2xl p-8 max-w-md w-full shadow-xl" @click.away="modaldel = false">
            <div class="text-center mb-6">
                ...
                <h6 class="text-lg font-bold text-gray-800 mb-2">Hapus Tahun Ajaran?</h6>
                <p class="text-sm text-gray-500">
                    Apakah Anda yakin ingin menghapus <span x-text="tahunAjaran.year_name + ' ' + tahunAjaran.semester" class="font-bold text-gray-800"></span>?
                </p>
            </div>

            <div class="flex items-center gap-3">
                <a :href="'<?= base_url('/admin/tahun-ajaran/del') ?>/' + tahunAjaran.id" class="flex-1 text-center font-bold cursor-pointer bg-gradient-to-r from-rose-600 to-red-500 rounded-2xl text-white py-3 px-5 hover:from-rose-700 hover:to-red-600 transition-all duration-300 shadow-md hover:shadow-lg active:scale-[0.98] text-sm">
                    Ya, Hapus
                </a>
