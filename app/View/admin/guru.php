...
<div class="ml-0 md:ml-72 sm:ml-0 bg-gray-100 min-h-screen"
                    ...
                    <div class="font-bold py-8 px-10 border-b border-gray-200 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col">
                                ...
                                <h6 class="text-base font-bold text-gray-800">Data Akun Guru</h6>
                            </div>
                        </div>
                                                ...
                                                <td class="px-4 py-2">
                                                    <div class="flex items-center justify-center gap-1">
                                                        ...
                                                        <button
                                                            ...
                                                            class="cursor-pointer px-2.5 py-1.5 rounded-xl text-gray-600 hover:text-emerald-600 hover:bg-emerald-50 active:scale-95 transition-all flex items-center gap-1 font-semibold text-xs border border-transparent hover:border-emerald-200">
        ...
        <form action="<?= base_url('/admin/guru') ?>" method="post" class="w-full max-w-lg">
            <div class="bg-white rounded-2xl p-8 shadow-xl" @click.away="modaladd = false">
                <div class="flex justify-between items-center mb-6 pb-4 border-b border-gray-100">
                    <h6 class="font-bold text-lg text-gray-800">Tambah Akun Guru</h6>
    ...
    <div 
        ...
        <div class="bg-white rounded-2xl p-8 max-w-md w-full shadow-xl" @click.away="modaldel = false">
            <div class="text-center mb-6">
                ...
                <h6 class="text-lg font-bold text-gray-800 mb-2">Hapus Akun Guru?</h6>
                <p class="text-sm text-gray-500">
                    Apakah Anda yakin ingin menghapus akun <span x-text="userdata.full_name" class="font-bold text-gray-800"></span>?
                </p>
            </div>

            <div class="flex items-center gap-3">
                <a :href="'<?= base_url('/admin/guru/del') ?>/' + userdata.user_id" class="flex-1 text-center font-bold cursor-pointer bg-gradient-to-r from-rose-600 to-red-500 rounded-2xl text-white py-3 px-5 hover:from-rose-700 hover:to-red-600 transition-all duration-300 shadow-md hover:shadow-lg active:scale-[0.98] text-sm">
                    Ya, Hapus
                </a>
    ...
    <div 
        ...
        <div class="bg-white rounded-2xl p-8 max-w-md w-full shadow-xl" @click.away="modalresetpass = false">
            <div class="text-center mb-6">
                ...
                <h6 class="text-lg font-bold text-gray-800 mb-2">Reset Password Akun?</h6>
                <p class="text-sm text-gray-500 mb-3">
                    Apakah Anda yakin ingin mereset password untuk <span x-text="userdata.full_name" class="font-bold text-gray-800"></span>?
                </p>
                <div class="bg-emerald-50 border border-emerald-200/60 rounded-xl p-3 text-xs text-emerald-800 font-medium">
                    Password baru akan sama dengan username: <span x-text="userdata.username" class="font-bold"></span>
                </div>
            </div>

            <div class="flex items-center gap-3">
                <a :href="'<?= base_url('/admin/guru/reset') ?>/' + userdata.user_id" class="flex-1 text-center font-bold cursor-pointer bg-gradient-to-r from-emerald-600 to-teal-500 rounded-2xl text-white py-3 px-5 hover:from-emerald-700 hover:to-teal-600 transition-all duration-300 shadow-md hover:shadow-lg active:scale-[0.98] text-sm">
                    Ya, Reset
                </a>
