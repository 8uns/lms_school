...
Router::add('GET', '/guru/bank-soal/subject/([0-9]*)/class/([0-9]*)', GuruBanksoalController::class, 'index', [AuthMiddleware::class,  RoleMiddleware::class . ':Guru']); // menu manage guru
